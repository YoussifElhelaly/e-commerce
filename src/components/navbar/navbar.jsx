        ...
        <nav lightMode = {`${lightmode}`}>
                        ...
                        <div className="col-3">
                            <div className="user-nav d-flex justify-content-end">
                                <ul className='d-flex'>
                                    ...
                                    <li>
                                        <Link to="/whishlist" className='wish'>
            ...
            <div className="mobile-nav">
                ...
                <div className="row align-items-center justify-content-between m-0">
                    ...
                    <div className="col-5">
                            <div className="user-nav d-flex justify-content-end w-100 align-items-center">
                                <ul className='d-flex justify-content-between w-100 align-items-center m-0'>
                                    <li>
                                        <Link to="/Compare" className='compare'>
                                        <i className="fa-solid fa-arrow-right-arrow-left"></i>
                                    </Link>
