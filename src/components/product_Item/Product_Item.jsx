        ...
        <div  className="productItem">
            ...
            <div className="productItemHover">
                <div className="icons d-flex justify-content-around">
                    <span className="whishlist"><i className="fa-regular fa-heart"></i> Whishlist</span>
                    <span className="compare"><i className="fa-solid fa-arrow-right-arrow-left"></i> Whishlist</span>
                </div>
            </div>
        </div>
    )
